...
2017-12-05
北京新发地粮油
第一页:http://www.xinfadi.com.cn/marketanalysis/5/list/1.shtml
最后一页;http://www.xinfadi.com.cn/marketanalysis/5/list/179.shtml
"""
headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.113 Safari/537.36'}
URL = 'http://www.xinfadi.com.cn/marketanalysis/5/list/{}.shtml'
...
def insert_into_mysql(item):
    try:
        with connection.cursor() as cursor:
            sql = 'INSERT INTO oil_rice(names,low_price,avg_price,high_price,guige,unit,times) VALUES (%s,%s,%s,%s,%s,%s,%s)'
